...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 25 sources (git), 1,641 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 665 | `v1.4.0` | — | 2d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 537 | `v0.15.0` | — | 2d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 294 | `v1.14.2` | 6.0k | today |
...
<!-- NOW:START -->
```console
2026-08-25  TokenBar            chore(release): notes for v1.14.2
2026-08-25  TokenBar            fix(antigravity): anchor the client id on its last hyphen,
2026-08-24  TokenBar            fix(antigravity): stop the OAuth client scan from eating a

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,026 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2324 | `v0.8.0` | — | 1d ago |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 683 | `v1.4.1` | — | 9d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 539 | `v0.15.0` | — | 14d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 328 | `v1.16.0` | 4.8k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 39 | 6d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.22` | 58 | today |
...
<!-- NOW:START -->
```console
2026-09-06  TokenBar            refactor(test): fold the turn-report fixture-health checks
2026-09-06  TokenBar            refactor(quota-history): delete the four operator-copy tes
2026-09-06  TokenBar            refactor(test): cut the filter-parity probe tests to the c
2026-09-06  TokenBar            refactor(quota-history): delete the fit work counters and 
2026-09-06  calico-claude       feat(disable-bash-first): default upstream's Bash-first to
```
<!-- NOW:END -->
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-06 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 29 sources (git), 4,583 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2794 | `v0.12.2` | — | today |
...
<!-- NOW:START -->
```console
2026-09-23  Syrtis-Windows      docs(release): list the turn-count fix under "Also in this
2026-09-23  Syrtis-Windows      chore(release): bump the version contract to 0.4.1, and co

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,367 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2620 | `v0.10.0` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 694 | `v1.4.1` | — | 18d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 541 | `v0.16.1` | — | 8d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 349 | `v1.17.0` | 5.5k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 79 | `—` | — | 8d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.23` | 66 | 8d ago |
...
<!-- NOW:START -->
```console
2026-09-15  Syrtis-Windows      docs(contributing): derive the branch type from the topic'
2026-09-15  tokscale-core       docs(contributing): derive the branch type from the topic'
2026-09-15  TokenBar            docs(workflow): derive the branch type from the topic's pr
2026-09-15  Syrtis-Windows      docs(contributing): name the commit types in use and leave
2026-09-15  tokscale-core       docs(contributing): name the commit types in use and leave
```
<!-- NOW:END -->
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-15 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 29 sources (git), 4,560 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2777 | `v0.12.0` | — | 1d ago |
...
<!-- NOW:START -->
```console
2026-09-22  calico-claude       fix(installer): test the joined version output, not the ar
2026-09-22  calico-claude       feat(watch): resolve the upstream version across every npm

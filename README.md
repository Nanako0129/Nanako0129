...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 29 sources (git), 4,619 stars      │
│       daM&&&888888888888888888888&&M#op    Shell: zsh + powerlevel10k                   │
│        h**MMW&&&&8&8&888&8&&&&&&WM#M&8M    DE: coralline (Claude Code statusline)       │
│       mhM8%%BB%%88&88&&&888%BBBBB%8%h8#    Homelab: Proxmox, 22d up, 0 open ports       │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2831 | `v0.12.2` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 697 | `v1.4.1` | — | today |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 541 | `v0.17.0` | — | today |
...
```console
Proxmox VE      22d uptime · every service in Compose, every service healthchecked

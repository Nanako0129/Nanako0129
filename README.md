...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 29 sources (git), 4,529 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2751 | `v0.12.0` | — | 1d ago |
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 361 | `v1.20.0` | 6.2k | today |
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-21 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

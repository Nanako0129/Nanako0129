...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 29 sources (git), 4,576 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2788 | `v0.12.2` | — | today |
...
<!-- NOW:START -->
```console
2026-09-23  calico-claude       docs(update): drop the fixed assertion count; list --unatt
2026-09-22  stingray            docs(shape3): separate the direct 59-line probe from the 4
2026-09-22  stingray            fix(shape3): count only scored fixture lines, and correct 
2026-09-22  stingray            feat(shape3)!: let Jev judge whether a reply promises to w
2026-09-22  calico-claude       fix(update): harden update.sh's unattended path, attestati
```
<!-- NOW:END -->

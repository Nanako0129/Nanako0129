...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,363 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2618 | `v0.10.0` | — | 4d ago |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 693 | `v1.4.1` | — | 18d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 541 | `v0.16.1` | — | 8d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 348 | `v1.17.0` | 5.5k | today |
...
<!-- NOW:START -->
```console
2026-09-15  TokenBar            fix(quota): stop a cancelled registry sleep from parking f
2026-09-15  TokenBar            test(selftest): drop the scan caches explicitly where five
2026-09-14  calico-claude       fix(patterns): re-anchor the two modules upstream 2.1.271 

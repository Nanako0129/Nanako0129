...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 24 sources (git), 1,453 stars      │
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 245 | `v1.12.0` | 4.5k | today |
...
<!-- NOW:START -->
```console
2026-08-07  pilotfish           feat(policy): add adaptive interaction routing (#55)

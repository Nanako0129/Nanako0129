...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,094 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2385 | `v0.8.0` | — | 1d ago |
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 334 | `v1.16.0` | 4.9k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 39 | today |
...
<!-- NOW:START -->
```console
2026-09-07  tokscale-core       docs: stop the stale-cache test requirement from contradic
2026-09-07  tokscale-core       docs: keep the shared-fixture convention the repository ac
2026-09-07  tokscale-core       docs: name the synthetic namespace's own parser version
2026-09-07  tokscale-core       fix(docs): scope cache invalidation by whose payload stops
2026-09-07  tokscale-core       fix(docs): correct the Claude cache-invalidation guidance
```
<!-- NOW:END -->

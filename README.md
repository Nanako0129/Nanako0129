...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 25 sources (git), 1,637 stars      │
│       daM&&&888888888888888888888&&M#op    Shell: zsh + powerlevel10k                   │
│        h**MMW&&&&8&8&888&8&&&&&&WM#M&8M    DE: coralline (Claude Code statusline)       │
│       mhM8%%BB%%88&88&&&888%BBBBB%8%h8#    Homelab: Proxmox, 240d up, 0 open ports      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 661 | `v1.4.0` | — | 2d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 537 | `v0.15.0` | — | 2d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 294 | `v1.14.1` | 6.0k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS, built to defeat tethering limits | ★ 77 | `v0.1.0` | 27 | today |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.22` | 118 | 7d ago |
...
<!-- USAGE:START -->
```console
last 7 days · 4.1B tokens · 12,540 messages

  claude-opus-5       ███████████████░░░░░░░  68.9%     2792M
  gpt-5.6-sol         █████░░░░░░░░░░░░░░░░░  20.7%      838M
  claude-fable-5      █░░░░░░░░░░░░░░░░░░░░░   5.6%      229M
  claude-sonnet-5     █░░░░░░░░░░░░░░░░░░░░░   3.2%      129M
  claude-opus-4-8     ░░░░░░░░░░░░░░░░░░░░░░   0.6%       22M
  gpt-5.6-luna        ░░░░░░░░░░░░░░░░░░░░░░   0.5%       20M
```
<!-- USAGE:END -->
...
<!-- NOW:START -->
```console
2026-08-24  TokenBar            chore(release): the v1.14.1 notes, replacing v1.14.0's
2026-08-24  TokenBar            fix(quota): state the ratio's token basis once, and apply 
2026-08-24  TokenBar            fix(quota): count the equivalence denominator over the tok
2026-08-24  TokenBar            chore(release): the usage chart is not hideable, and that 
2026-08-24  TokenBar            chore(release): the launch fix covers quota fetches too, a
```
<!-- NOW:END -->
...
```console
Proxmox VE      240d uptime · every service in Compose, every service healthchecked
...
<sub>This page rebuilds itself nightly · last sync: 2026-08-25 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

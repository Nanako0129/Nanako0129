...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,388 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2645 | `v0.10.0` | — | today |
...
2026-09-16  sepia               fix(sepia): journalism rule 3 scoped to the target languag
2026-09-16  sepia               fix(sepia): journalism rule 6 bans only generic outlook, k
```
<!-- NOW:END -->

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 3,599 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 1901 | `v0.5.0` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 683 | `v1.4.1` | — | 6d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 540 | `v0.15.0` | — | 12d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 324 | `v1.14.4` | 4.5k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 38 | 3d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.22` | 58 | 17d ago |
...
<!-- NOW:START -->
```console
2026-09-03  calico-claude       fix(custom-context-window): accept a wrapped headers param
2026-09-03  TokenBar            fix(models): give the cost warning an accessibility label,
2026-09-03  TokenBar            fix(models): let the hover tooltip wrap the model name ins
2026-09-03  calico-claude       fix(usage-wrapup): close the text gate that bypassed the r
2026-09-03  TokenBar            fix(models): judge cost plausibility after the provider fo
```
<!-- NOW:END -->
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-04 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

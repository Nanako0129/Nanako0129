...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 25 sources (git), 1,662 stars      │
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 300 | `v1.14.3` | 6.3k | today |
...
<!-- NOW:START -->
```console
2026-08-27  pilotfish           feat(benchmarks): bind dispatch-brake runs (#73)
2026-08-27  pilotfish           feat(benchmarks): bind cue-free TUI attempts (#72)
2026-08-27  pilotfish           feat(benchmarks): bind prompt-compression attempts (#71)
2026-08-27  calico-claude       fix(patch): support Claude 2.1.247, and gate releases on a

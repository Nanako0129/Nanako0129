...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,175 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2460 | `v0.9.0` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 683 | `v1.4.1` | — | 11d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 540 | `v0.16.1` | — | 1d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 339 | `v1.16.0` | 5.0k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 42 | 1d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.23` | 61 | 1d ago |
...
2026-09-08  tokscale-core       docs(tokens): correct two comments that describe the pre-p
2026-09-08  tokscale-core       docs(upstream): record the 1h pricing patch and repair the
2026-09-08  tokscale-core       fix(claude): price 1-hour cache writes at their own rate
2026-09-08  TokenBar            docs(vendor): correct the fifth statement of the pin-only 
```
<!-- NOW:END -->
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-09 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,023 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2321 | `v0.8.0` | — | 1d ago |
...
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 39 | 5d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.22` | 58 | 20d ago |
...
2026-09-06  calico-claude       fix(compact-tokens-saved): apply both injections or neithe
2026-09-06  calico-claude       feat(compact-tokens-saved): report what /compact actually 
2026-09-06  TokenBar            chore(release): emit the cask with postflight_steps
2026-09-05  TokenBar            chore(release): notes for v1.16.0
```
<!-- NOW:END -->

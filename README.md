...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 22 sources (git), 1,352 stars      │
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 208 | `v1.9.0` | 3.6k | today |
...
<!-- NOW:START -->
```console
2026-07-28  TokenBar-Windows    fix(core): sync platform-scoped test helpers
2026-07-28  TokenBar            fix(core): align test helpers with platform cfg
2026-07-28  coralline           feat(windows): add native PowerShell subagent rows (#56)
2026-07-28  TokenBar-Windows    fix(core): sync Rust 1.96 Clippy rename
2026-07-28  TokenBar            fix(core): satisfy Rust 1.96 Clippy convention
```
<!-- NOW:END -->

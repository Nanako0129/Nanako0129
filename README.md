...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 26 sources (git), 2,260 stars      │
...
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 591 | `v0.2.0` | — | today |
...
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS, built to defeat tethering limits | ★ 78 | `v0.1.0` | 32 | 4d ago |
...
<!-- NOW:START -->
```console
2026-08-29  NyanCogs            fix(channelsummary): accept bounded valid source reference

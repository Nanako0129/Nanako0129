...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 2,939 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 1255 | `v0.4.0` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 683 | `v1.4.1` | — | 3d ago |
| **[coralline](https://github.com/Nanako0129/coralline)** | Powerlevel10k-inspired statusline for Claude Code | ★ 538 | `v0.15.0` | — | 9d ago |
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 315 | `v1.14.4` | 4.3k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 32 | today |
...
<!-- USAGE:START -->
```console
last 7 days · 3.5B tokens · 11,688 messages

  claude-opus-5       ██████████░░░░░░░░░░░░  47.7%     1657M
  gpt-5.6-sol         ████████░░░░░░░░░░░░░░  34.3%     1191M

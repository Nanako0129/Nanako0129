...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 3,987 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2285 | `v0.8.0` | — | today |
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 328 | `v1.16.0` | 4.7k | today |
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS and Android, built to defeat tethering limits | ★ 78 | `v0.1.0` | 38 | 5d ago |
| **[remora-cc](https://github.com/Nanako0129/remora-cc)** | Session-scoped GPT-5.6 agent routing | ★ 27 | `v0.1.22` | 58 | 19d ago |
...
2026-09-05  TokenBar            chore(ffi): drop the one dead-code warning left in the tes
2026-09-05  TokenBar            chore(ffi): clear the four dead-code warnings from the rel
2026-09-05  TokenBar            fix(i18n): translate the last window-label site and close 
2026-09-05  sepia               chore(release): bump version to 0.8.0
```
<!-- NOW:END -->

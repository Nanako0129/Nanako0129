...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 24 sources (git), 1,508 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 592 | `v1.3.10` | — | 3d ago |
...
| **[SocksBypass](https://github.com/Nanako0129/SocksBypass)** | SOCKS5 proxy for iOS, built to defeat tethering limits | ★ 69 | `v0.1.0` | 16 | today |

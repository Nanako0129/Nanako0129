...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,102 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2392 | `v0.8.0` | — | 2d ago |
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 335 | `v1.16.0` | 4.9k | today |
...
2026-09-07  TokenBar            chore(tooling): split the pin-consistency check out of the
2026-09-07  TokenBar            fix(tooling): cover engine permalinks in the pin check, an
```
<!-- NOW:END -->

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 4,286 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 2556 | `v0.10.0` | — | today |
| **[pilotfish](https://github.com/Nanako0129/pilotfish)** | Multi-model orchestration for Claude Code | ★ 688 | `v1.4.1` | — | 14d ago |
...
<sub>This page rebuilds itself every six hours · last sync: 2026-09-12 · <a href="https://github.com/Nanako0129/Nanako0129/blob/main/scripts/update_readme.py">how</a></sub>

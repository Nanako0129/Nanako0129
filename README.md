...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 27 sources (git), 3,670 stars      │
...
| :-- | :-- | --: | :-- | --: | :-- |
| **[sepia](https://github.com/Nanako0129/sepia)** | De-AI writing skill for coding agents | ★ 1970 | `v0.7.0` | — | today |
...
2026-09-04  sepia               fix(sepia): scope the rhythm evidence to within-text studi
2026-09-04  sepia               fix(sepia): narrow the SD claim, bind the tail expectation
```
<!-- NOW:END -->

...
│      oW&fW&8&888888888888888888&&&oM8&o    Packages: 24 sources (git), 1,528 stars      │
...
| **[TokenBar](https://github.com/Nanako0129/TokenBar)** | Native macOS menu-bar monitor for AI token usage | ★ 261 | `v1.13.2` | 5.1k | today |
...
2026-08-15  tokscale-core       fix(source-context): keep Linux config under supplied home
```
<!-- NOW:END -->
